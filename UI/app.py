...
parkin_model = pickle.load(open(f"{working_dir}/../models/parkin_model.sav", 'rb'))
...
with st.sidebar:
    ...
    selected = option_menu("Multiple disease prediction system", [
        'Diabetes Prediction', 'Heart Disease Prediction', 'Parkinson Disease'
...
if selected == 'Parkinson Disease':
    ...
    if st.button("Parkinson's Test Result"):
        ...
        parkinsons_prediction = parkin_model.predict([user_input])
